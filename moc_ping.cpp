...
static const char qt_meta_stringdata_Ping[] = {
    "Ping\0\0,\0dane(QString,int)\0"
};

const QMetaObject Ping::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Ping,
      qt_meta_data_Ping, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Ping::getStaticMetaObject() { return staticMetaObject; }
...
int Ping::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: dane((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void Ping::dane(QString _t1, int _t2)
{
